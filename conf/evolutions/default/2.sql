...
insert into hole (id,hole_number,par,diffindex,score) values ( 1,1,4,1,7 );
insert into hole (id,hole_number,par,diffindex,score) values ( 2,2,4,2,8 );
insert into hole (id,hole_number,par,diffindex,score) values ( 3,3,4,3,7 );
insert into hole (id,hole_number,par,diffindex,score) values ( 4,4,4,4,7 );
